...
const container = document.getElementById("novoParagrafo");

incrementarButton.addEventListener("click", incrementar);
zerarButton.addEventListener("click", zerarContador);
...
function atualizarContador() {
  ...
  novoParagrafo.innerText = `O contador esta com ${contador} cliques`;
